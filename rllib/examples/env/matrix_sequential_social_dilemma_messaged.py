...
from ray.rllib.examples.env.utils.mixins import (
    ...
    MessagedTwoPlayersTwoActionsInfoMixin,
...
class MatrixSequentialSocialDilemma(InfoAccumulationInterface, MultiAgentEnv, ABC):
    ...
    def _get_players_rewards(self, action_player_0: int, action_player_1: int):
        actual_action_player_0 = action_player_0 // self.NUM_ACTIONS
        actual_action_player_1 = action_player_1 // self.NUM_ACTIONS
        return [
            self.PAYOUT_MATRIX[actual_action_player_0][actual_action_player_1][0],
            self.PAYOUT_MATRIX[actual_action_player_0][actual_action_player_1][1],
        ]
...
class MessageIteratedPrisonersDilemma(
    MessagedTwoPlayersTwoActionsInfoMixin, MatrixSequentialSocialDilemma
):
    """
    ...
    NUM_MESSAGES = 2
    NUM_ACTIONS = (
        NUM_ACTIONS * NUM_MESSAGES
    )  # actual action space X message space, message space
    NUM_STATES = NUM_ACTIONS**NUM_AGENTS + 1
    ACTION_SPACE = Discrete(NUM_ACTIONS)
    # ACTION_SPACE = Discrete(NUM_ACTIONS * NUM_ACTIONS)
